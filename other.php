    ...
    <section id="recent" class="section-padding pb-85 portfolio-area">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <div class="section-title text-center">
                        <h2 style="color: #fff;">Other Works</h2>
                        <h5 style="color: #F5BD02;">Check our other skills, we can provide to you</h5>
            ...
            <div class="row portfolio">
                <!-- Single Portfolio -->
                <?php
                $yt_rs = Database::search("SELECT * FROM images INNER JOIN portfolio ON images.portfolio_id = portfolio.id WHERE images.portfolio_id = 7 ORDER BY RAND()");
