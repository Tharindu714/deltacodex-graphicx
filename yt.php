    ...
    <section id="recent" class="section-padding pb-85 portfolio-area">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <div class="section-title text-center">
                        <h2 style="color: #fff;">Youtube Thumbnail Designs</h2>
                        <h5 style="color: #F5BD02;">Design your first impression of the youtube with us</h5>
            ...
            <div class="row portfolio">
                <!-- Single Portfolio -->
                <?php
                $yt_rs = Database::search("SELECT * FROM images INNER JOIN portfolio ON images.portfolio_id = portfolio.id WHERE images.portfolio_id = 4 ORDER BY RAND()");
